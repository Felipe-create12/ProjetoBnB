  ...
  return (
    <div className="shadow-md">
      ...
      <div className="flex items-center justify-between px-8 py-4 max-w-7xl mx-auto ">
          ...
          <div className="flex flex-row items-center border-gray-300 pr-4 pl-6 py-2 rounded-full shadow-md">
          ...
          <div className="flex flex-row items-center border-gray-300 pr-4 pl-6 py-2 rounded-full shadow-md gap-2">
